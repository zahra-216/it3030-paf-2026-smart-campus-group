        ...
        <div style={styles.page}>
            ...
            <div style={styles.statsRow}>
                {[
                    ...
                    { label: "Booking Alerts", value: notifications.filter(n => n.type === "BOOKING").length, icon: "📅", bg: "#EFF6FF", color: "#1D4ED8" },
                    { label: "Ticket Alerts", value: notifications.filter(n => n.type === "TICKET").length, icon: "🔧", bg: "#FFF1F2", color: "#DC2626" },
                ].map((s, i) => (
            ...
            <div style={styles.listWrap}>
                {loading ? (
                    ...
                    <div style={styles.empty}>
                        ...
                        <p style={styles.emptyDesc}>No notifications right now. Check back later.</p>
                    </div>
                ) : (
                    <>
                        {/* Unread */}
                        {displayedNotifs.some(n => !n.isRead) && (
...
const styles = {
    ...
    headerTitle: { fontFamily: "var(--font-heading)", fontSize: "1.4rem", fontWeight: 700, color: "var(--color-text)", marginBottom: 2 },
    ...
    filterBtnActive: { backgroundColor: "#E8F5E9", color: "var(--color-primary)", fontWeight: 700 },
    filterCount: {
        fontSize: "0.65rem", fontWeight: 700, padding: "1px 6px",
        borderRadius: 10, minWidth: 18, textAlign: "center",
    },
    listWrap: { display: "flex", flexDirection: "column", gap: "1.25rem" },
    ...
    sectionDot: { width: 7, height: 7, borderRadius: "50%", backgroundColor: "var(--color-primary)", flexShrink: 0 },
    card: {
    ...
    typeBadge: { fontSize: "0.65rem", fontWeight: 700, padding: "2px 8px", borderRadius: 6, textTransform: "uppercase", letterSpacing: "0.05em" },
    timeAgo: { fontSize: "0.72rem", color: "var(--color-text-light)", marginLeft: "auto" },
    message: { fontSize: "0.875rem", lineHeight: 1.55 },
    markBtn: {
    ...
    readDot: { width: 8, height: 8, borderRadius: "50%", backgroundColor: "var(--color-light-gray)", flexShrink: 0, marginTop: 6 },
    showMoreBtn: {
        padding: "0.75rem", backgroundColor: "var(--color-white)",
    ...
    empty: { backgroundColor: "var(--color-white)", borderRadius: 14, padding: "4rem", border: "1px solid var(--color-border)", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem", textAlign: "center" },
    emptyIconWrap: { width: 72, height: 72, borderRadius: "50%", backgroundColor: "#E8F5E9", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 8 },
    emptyTitle: { fontFamily: "var(--font-heading)", fontSize: "1.1rem", fontWeight: 700, color: "var(--color-text)" },
    emptyDesc: { fontSize: "0.85rem", color: "var(--color-text-light)", maxWidth: 300, lineHeight: 1.6 },
};